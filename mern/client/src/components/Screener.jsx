...
const COLUMNS = [
  ...
  // 4-line stack alignment: close > EMA9 > EMA21 > VWAP > EMA200 (UP) or
  // the inverse (DOWN). Distinct from `trend` (ADX directional reading).
  { key: "trend_stack", label: "Stack",   align: "left",
    format: (v) => v || "—",
    classer: (v) => v === "UP" ? "trend-bull" : v === "DOWN" ? "trend-bear" : "trend-neutral" },
  ...
  { key: "ema9",        label: "EMA9",    align: "right", format: money },
  { key: "ema21",       label: "EMA21",   align: "right", format: money },
  { key: "vwap",        label: "VWAP",    align: "right", format: money },
  { key: "ema200",      label: "EMA200",  align: "right", format: money },
  ...
  // 15-minute volume — the latest 15m bar's traded contracts, with its
  // own multiple-of-average column. "High right now" vs "high today".
  { key: "volume_15m",  label: "15m Vol", align: "right", format: vol },
  { key: "volume_15m_x_avg", label: "15m RVol", align: "right",
